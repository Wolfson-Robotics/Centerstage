...
if(!stop) {
    ...
    elbowServo.setPosition(0.6900000000000002);
    sleep(500);
    moveBotExact(768.0,1,0,0);
    armServo.setPosition(0.5422222222222222);
    sleep(500);
    elbowServo.setPosition(0.6900000000000002);
    sleep(500);
    moveBotExact(-169.0,1,0,0);
    armServo.setPosition(0.5016666666666667);
    sleep(500);
    elbowServo.setPosition(0.55);
    sleep(500);
    moveBotExact(277.0,1,0,0);
    armServo.setPosition(0.5016666666666667);
    sleep(500);
    elbowServo.setPosition(0.55);
    sleep(500);
    ...
    sleep(500);
    moveBotExact(-400.0,0,0,1);
    sleep(500);
    armServo.setPosition(0.5016666666666667);
    sleep(500);
    elbowServo.setPosition(0.55);
    sleep(500);
    moveBotExact(-958.0,0,0,1);
    sleep(500);
    armServo.setPosition(0.5016666666666667);
    sleep(500);
    elbowServo.setPosition(0.55);
    sleep(500);
    moveBotExact(614.0,1,0,0);
    armServo.setPosition(0.5016666666666667);
    sleep(500);
    elbowServo.setPosition(0.55);
    sleep(500);
