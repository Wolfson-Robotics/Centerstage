...
if(!stop) {
    stop = true;
    moveBotExact(291.0,0,0,-1);
    sleep(500);
    turnBot(64);
    sleep(1000);
    moveBotExact(746.0,1,0,0);
    sleep(500);
    moveBotExact(758.0,0,0,1);
    sleep(500);
    turnBot(170);
    sleep(1000);
    armServo.setPosition(0.55);
    sleep(500);
    elbowServo.setPosition(0.7000000000000002);
    sleep(500);
    sleep(500);
    armServo.setPosition(0.55);
    ...
    sleep(1000);
    armServo.setPosition(0.5422222222222222);
    sleep(500);
    elbowServo.setPosition(0.6900000000000002);
    sleep(500);
    armServo.setPosition(0.5016666666666667);
    sleep(500);
    elbowServo.setPosition(0.5394444444444444);
    sleep(500);
    turnBot(-109);
    sleep(1000);
    armServo.setPosition(0.5016666666666667);
    ...
    elbowServo.setPosition(0.5394444444444444);
    sleep(500);
    moveBotExact(2313.0,1,0,0);
    sleep(500);
    moveBotExact(2346.0,0,0,1);
    sleep(500);
    turnBot(526);
    sleep(1000);
    armServo.setPosition(0.5016666666666667);
    ...
    elbowServo.setPosition(0.5394444444444444);
    sleep(500);
    moveBotExact(342.0,1,0,0);
    sleep(500);
    moveBotExact(354.0,0,0,1);
    sleep(500);
    turnBot(78);
    sleep(1000);
    armServo.setPosition(0.5016666666666667);
    ...
    elbowServo.setPosition(0.5394444444444444);
    sleep(500);
    armServo.setPosition(0.5416666666666667);
    sleep(500);
    elbowServo.setPosition(0.6294444444444445);
    sleep(500);
    claw1.setPosition(0.00);
    sleep(500);
    moveBotExact(802.0,0,0,1);
    sleep(500);
    turnBot(-181);
    sleep(1000);
    armServo.setPosition(0.5416666666666667);
    sleep(500);
    elbowServo.setPosition(0.6994444444444445);
    sleep(500);
    moveBotExact(342.0,1,0,0);
    sleep(500);
    moveBotExact(344.0,0,0,1);
    sleep(500);
    turnBot(78);
    sleep(1000);
    armServo.setPosition(0.5416666666666667);
    ...
    sleep(500);
            ...
            // robot must be 8.5 inches away from the left
